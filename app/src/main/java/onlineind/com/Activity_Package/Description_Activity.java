...
public class Description_Activity extends AppCompatActivity {
       ...
       // Toast.makeText(this, ""+get_news_image, Toast.LENGTH_SHORT).show();
        ...
        news_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog nagDialog = new Dialog(Description_Activity.this, android.R.style.Theme_Translucent_NoTitleBar_Fullscreen);
       ...
       /* news_image.setOnClickListener(new View.OnClickListener() {
        ...
        iv_bookmark.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!str_user_id.isEmpty()) {
                            SubmitBookmark sb = new SubmitBookmark(Description_Activity.this);
                            sb.execute(get_news_id, str_user_id);
                            iv_bookmark.setVisibility(View.GONE);
                            iv_gold_bookmark.setVisibility(View.VISIBLE);

                        }else {
                            Toast.makeText(Description_Activity.this, "Please Register Your Self..", Toast.LENGTH_SHORT).show();
        ...
        iv_like.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                          ...
                          if (!str_user_id.isEmpty()) {
                              SubmitLike bt = new SubmitLike(Description_Activity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(Description_Activity.this, Comment_Activity.class);
            // finish();
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
