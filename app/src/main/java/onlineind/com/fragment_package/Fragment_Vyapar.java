...
import static onlineind.com.Https_Urls.Urls.VYAPAR;


public class Fragment_Vyapar extends Fragment {
    View view;
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(),"व्यापार");
        home_adapter.clear();
    ...
    private void loadVyaparNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, VYAPAR,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String result) {

                        Log.d("VyaparNews", result);
    ...
    private void loadMoreVyaparNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
