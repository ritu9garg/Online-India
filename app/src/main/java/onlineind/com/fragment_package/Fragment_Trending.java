...
import static onlineind.com.Https_Urls.Urls.TRENDING;
...
public class Fragment_Trending extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(),"ट्रेंडिंग");
        home_adapter.clear();
    ...
    private void loadTrendingNews() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, TRENDING,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String result) {

                               Log.d("TrendingNews", result);
    ...
    private void loadMoreTrendingNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
