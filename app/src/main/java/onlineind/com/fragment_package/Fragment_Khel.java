...
import static onlineind.com.Https_Urls.Urls.KHEL;
import static onlineind.com.Https_Urls.Urls.LOADMORE;


public class Fragment_Khel extends Fragment {
    View view;
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(),"खेल");
        home_adapter.clear();
    ...
    private void loadKhelNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, KHEL,
