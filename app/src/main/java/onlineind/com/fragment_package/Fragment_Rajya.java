...
import static onlineind.com.Https_Urls.Urls.RAJYA;


public class Fragment_Rajya extends Fragment {
    View view;
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(), "राज्य");
        home_adapter.clear();
    ...
    private void loadRajyaNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, RAJYA,
    ...
    private void loadMoreRajyaNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
        requestQueue.add(stringRequest);
          // Toast.makeText(getContext(), ""+stringRequest, Toast.LENGTH_SHORT).show();
    }
