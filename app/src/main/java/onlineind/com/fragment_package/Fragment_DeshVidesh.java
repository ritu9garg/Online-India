...
import static onlineind.com.Https_Urls.Urls.DESH_VIDESH;
import static onlineind.com.Https_Urls.Urls.LOADMORE;


public class Fragment_DeshVidesh extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(), "देश-विदेश");
        home_adapter.clear();
    ...
    private void loadDeshVideshNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DESH_VIDESH,
