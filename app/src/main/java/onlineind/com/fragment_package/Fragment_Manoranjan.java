...
import static onlineind.com.Https_Urls.Urls.MANORANJAN;


public class Fragment_Manoranjan extends Fragment {
    View view;
    Context context;
    SliderLayout sliderLayout;
    RelativeLayout loaderitem;
    RelativeLayout loader;
    List<Home_GS> home_gsList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(),"मनोरंजन");
        home_adapter.clear();
    ...
    private void loadManoranjanNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, MANORANJAN,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String result) {

                                 Log.d("ManoranjanNews", result);
