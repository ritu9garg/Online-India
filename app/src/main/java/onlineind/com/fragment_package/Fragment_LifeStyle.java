...
import static onlineind.com.Https_Urls.Urls.LIFE_STYLE;
import static onlineind.com.Https_Urls.Urls.LOADMORE;


public class Fragment_LifeStyle extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(),"लाइफ स्टाइल");
        home_adapter.clear();
    ...
    private void loadLifeStyleNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, LIFE_STYLE,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String result) {

                                 Log.d("LifeStyleNews", result);
    ...
    private void loadMoreLifeStyleNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
