...
import static onlineind.com.Https_Urls.Urls.TAKNIK;


public class Fragment_Takniki extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(), "तकनीक");
        home_adapter.clear();
    ...
    private void loadTaknikiNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, TAKNIK,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String result) {

                                 Log.d("TaknikiNews", result);
    ...
    private void loadMoreTaknikiNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
