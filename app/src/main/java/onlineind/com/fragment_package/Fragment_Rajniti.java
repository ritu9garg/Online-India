...
import static onlineind.com.Https_Urls.Urls.RAJNITI;


public class Fragment_Rajniti extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(),"राजनीति");
        home_adapter.clear();
    ...
    private void loadRajnitiNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, RAJNITI,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String result) {

                                 Log.d("RajnitiNews", result);
    ...
    private void loadMoreRajnitiNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
