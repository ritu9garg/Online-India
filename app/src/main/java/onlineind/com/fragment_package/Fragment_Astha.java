...
import static onlineind.com.Https_Urls.Urls.AASTHA;
import static onlineind.com.Https_Urls.Urls.LOADMORE;

public class Fragment_Astha extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_adapter = new Home_Adapter(recyclerView, home_gsList, getActivity(),"आस्था");
        home_adapter.clear();
    ...
    private void loadAsthaNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AASTHA,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String result) {

                                 Log.d("AsthaNews", result);
    ...
    private void loadMoreAsthaNews() {
        //  Toast.makeText(this, "loadherors", Toast.LENGTH_SHORT).show();
